...
/*nestedFunction can access the variable internal because internal is within nestedFunction's scope. nestedFunction sits within myfunction, where internal is declared. */
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      sciAni.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    })
    return sciAni;
  }

  console.log('Array methods 1', animalNames(zooAnimals));
  ...
  */
  ...
  console.log('Array methods 2', lowerCaseNames(zooAnimals));
